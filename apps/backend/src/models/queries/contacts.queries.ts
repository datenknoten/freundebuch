...
const createContactIR: any = {"usedParamSet":{"displayName":true,"nickname":true,"namePrefix":true,"nameFirst":true,"nameMiddle":true,"nameLast":true,"nameSuffix":true,"jobTitle":true,"organization":true,"department":true,"workNotes":true,"interests":true,"userExternalId":true},"params":[{"name":"displayName","required":false,"transform":{"type":"scalar"},"locs":[{"a":297,"b":308}]},{"name":"nickname","required":false,"transform":{"type":"scalar"},"locs":[{"a":315,"b":323}]},{"name":"namePrefix","required":false,"transform":{"type":"scalar"},"locs":[{"a":330,"b":340}]},{"name":"nameFirst","required":false,"transform":{"type":"scalar"},"locs":[{"a":347,"b":356}]},{"name":"nameMiddle","required":false,"transform":{"type":"scalar"},"locs":[{"a":363,"b":373}]},{"name":"nameLast","required":false,"transform":{"type":"scalar"},"locs":[{"a":380,"b":388}]},{"name":"nameSuffix","required":false,"transform":{"type":"scalar"},"locs":[{"a":395,"b":405}]},{"name":"jobTitle","required":false,"transform":{"type":"scalar"},"locs":[{"a":412,"b":420}]},{"name":"organization","required":false,"transform":{"type":"scalar"},"locs":[{"a":427,"b":439}]},{"name":"department","required":false,"transform":{"type":"scalar"},"locs":[{"a":446,"b":456}]},{"name":"workNotes","required":false,"transform":{"type":"scalar"},"locs":[{"a":463,"b":472}]},{"name":"interests","required":false,"transform":{"type":"scalar"},"locs":[{"a":479,"b":488}]},{"name":"userExternalId","required":false,"transform":{"type":"scalar"},"locs":[{"a":530,"b":544}]}],"statement":"INSERT INTO contacts.contacts (\n    user_id,\n    display_name,\n    nickname,\n    name_prefix,\n    name_first,\n    name_middle,\n    name_last,\n    name_suffix,\n    -- Epic 1B: Professional fields\n    job_title,\n    organization,\n    department,\n    work_notes,\n    interests\n)\nSELECT\n    u.id,\n    :displayName,\n    :nickname,\n    :namePrefix,\n    :nameFirst,\n    :nameMiddle,\n    :nameLast,\n    :nameSuffix,\n    :jobTitle,\n    :organization,\n    :department,\n    :workNotes,\n    :interests\nFROM auth.users u\nWHERE u.external_id = :userExternalId\nRETURNING\n    external_id,\n    display_name,\n    nickname,\n    name_prefix,\n    name_first,\n    name_middle,\n    name_last,\n    name_suffix,\n    photo_url,\n    photo_thumbnail_url,\n    job_title,\n    organization,\n    department,\n    work_notes,\n    interests,\n    created_at,\n    updated_at"};
...
const updateContactIR: any = {"usedParamSet":{"displayName":true,"updateNickname":true,"nickname":true,"updateNamePrefix":true,"namePrefix":true,"updateNameFirst":true,"nameFirst":true,"updateNameMiddle":true,"nameMiddle":true,"updateNameLast":true,"nameLast":true,"updateNameSuffix":true,"nameSuffix":true,"updateJobTitle":true,"jobTitle":true,"updateOrganization":true,"organization":true,"updateDepartment":true,"department":true,"updateWorkNotes":true,"workNotes":true,"updateInterests":true,"interests":true,"contactExternalId":true,"userExternalId":true},"params":[{"name":"displayName","required":false,"transform":{"type":"scalar"},"locs":[{"a":59,"b":70}]},{"name":"updateNickname","required":false,"transform":{"type":"scalar"},"locs":[{"a":115,"b":129}]},{"name":"nickname","required":false,"transform":{"type":"scalar"},"locs":[{"a":136,"b":144}]},{"name":"updateNamePrefix","required":false,"transform":{"type":"scalar"},"locs":[{"a":195,"b":211}]},{"name":"namePrefix","required":false,"transform":{"type":"scalar"},"locs":[{"a":218,"b":228}]},{"name":"updateNameFirst","required":false,"transform":{"type":"scalar"},"locs":[{"a":281,"b":296}]},{"name":"nameFirst","required":false,"transform":{"type":"scalar"},"locs":[{"a":303,"b":312}]},{"name":"updateNameMiddle","required":false,"transform":{"type":"scalar"},"locs":[{"a":365,"b":381}]},{"name":"nameMiddle","required":false,"transform":{"type":"scalar"},"locs":[{"a":388,"b":398}]},{"name":"updateNameLast","required":false,"transform":{"type":"scalar"},"locs":[{"a":450,"b":464}]},{"name":"nameLast","required":false,"transform":{"type":"scalar"},"locs":[{"a":471,"b":479}]},{"name":"updateNameSuffix","required":false,"transform":{"type":"scalar"},"locs":[{"a":531,"b":547}]},{"name":"nameSuffix","required":false,"transform":{"type":"scalar"},"locs":[{"a":554,"b":564}]},{"name":"updateJobTitle","required":false,"transform":{"type":"scalar"},"locs":[{"a":652,"b":666}]},{"name":"jobTitle","required":false,"transform":{"type":"scalar"},"locs":[{"a":673,"b":681}]},{"name":"updateOrganization","required":false,"transform":{"type":"scalar"},"locs":[{"a":734,"b":752}]},{"name":"organization","required":false,"transform":{"type":"scalar"},"locs":[{"a":759,"b":771}]},{"name":"updateDepartment","required":false,"transform":{"type":"scalar"},"locs":[{"a":825,"b":841}]},{"name":"department","required":false,"transform":{"type":"scalar"},"locs":[{"a":848,"b":858}]},{"name":"updateWorkNotes","required":false,"transform":{"type":"scalar"},"locs":[{"a":910,"b":925}]},{"name":"workNotes","required":false,"transform":{"type":"scalar"},"locs":[{"a":932,"b":941}]},{"name":"updateInterests","required":false,"transform":{"type":"scalar"},"locs":[{"a":992,"b":1007}]},{"name":"interests","required":false,"transform":{"type":"scalar"},"locs":[{"a":1014,"b":1023}]},{"name":"contactExternalId","required":false,"transform":{"type":"scalar"},"locs":[{"a":1086,"b":1103}]},{"name":"userExternalId","required":false,"transform":{"type":"scalar"},"locs":[{"a":1150,"b":1164}]}],"statement":"UPDATE contacts.contacts c\nSET\n    display_name = COALESCE(:displayName, c.display_name),\n    nickname = CASE WHEN :updateNickname THEN :nickname ELSE c.nickname END,\n    name_prefix = CASE WHEN :updateNamePrefix THEN :namePrefix ELSE c.name_prefix END,\n    name_first = CASE WHEN :updateNameFirst THEN :nameFirst ELSE c.name_first END,\n    name_middle = CASE WHEN :updateNameMiddle THEN :nameMiddle ELSE c.name_middle END,\n    name_last = CASE WHEN :updateNameLast THEN :nameLast ELSE c.name_last END,\n    name_suffix = CASE WHEN :updateNameSuffix THEN :nameSuffix ELSE c.name_suffix END,\n    -- Epic 1B: Professional fields\n    job_title = CASE WHEN :updateJobTitle THEN :jobTitle ELSE c.job_title END,\n    organization = CASE WHEN :updateOrganization THEN :organization ELSE c.organization END,\n    department = CASE WHEN :updateDepartment THEN :department ELSE c.department END,\n    work_notes = CASE WHEN :updateWorkNotes THEN :workNotes ELSE c.work_notes END,\n    interests = CASE WHEN :updateInterests THEN :interests ELSE c.interests END\nFROM auth.users u\nWHERE c.external_id = :contactExternalId\n  AND c.user_id = u.id\n  AND u.external_id = :userExternalId\n  AND c.deleted_at IS NULL\nRETURNING\n    c.external_id,\n    c.display_name,\n    c.nickname,\n    c.name_prefix,\n    c.name_first,\n    c.name_middle,\n    c.name_last,\n    c.name_suffix,\n    c.photo_url,\n    c.photo_thumbnail_url,\n    c.job_title,\n    c.organization,\n    c.department,\n    c.work_notes,\n    c.interests,\n    c.created_at,\n    c.updated_at"};
