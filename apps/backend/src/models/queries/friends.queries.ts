...
const createFriendIR: any = {"usedParamSet":{"displayName":true,"nickname":true,"namePrefix":true,"nameFirst":true,"nameMiddle":true,"nameLast":true,"nameSuffix":true,"interests":true,"userExternalId":true},"params":[{"name":"displayName","required":false,"transform":{"type":"scalar"},"locs":[{"a":194,"b":205}]},{"name":"nickname","required":false,"transform":{"type":"scalar"},"locs":[{"a":212,"b":220}]},{"name":"namePrefix","required":false,"transform":{"type":"scalar"},"locs":[{"a":227,"b":237}]},{"name":"nameFirst","required":false,"transform":{"type":"scalar"},"locs":[{"a":244,"b":253}]},{"name":"nameMiddle","required":false,"transform":{"type":"scalar"},"locs":[{"a":260,"b":270}]},{"name":"nameLast","required":false,"transform":{"type":"scalar"},"locs":[{"a":277,"b":285}]},{"name":"nameSuffix","required":false,"transform":{"type":"scalar"},"locs":[{"a":292,"b":302}]},{"name":"interests","required":false,"transform":{"type":"scalar"},"locs":[{"a":309,"b":318}]},{"name":"userExternalId","required":false,"transform":{"type":"scalar"},"locs":[{"a":360,"b":374}]}],"statement":"INSERT INTO friends.friends (\n    user_id,\n    display_name,\n    nickname,\n    name_prefix,\n    name_first,\n    name_middle,\n    name_last,\n    name_suffix,\n    interests\n)\nSELECT\n    u.id,\n    :displayName,\n    :nickname,\n    :namePrefix,\n    :nameFirst,\n    :nameMiddle,\n    :nameLast,\n    :nameSuffix,\n    :interests\nFROM auth.users u\nWHERE u.external_id = :userExternalId\nRETURNING\n    external_id,\n    display_name,\n    nickname,\n    name_prefix,\n    name_first,\n    name_middle,\n    name_last,\n    name_suffix,\n    photo_url,\n    photo_thumbnail_url,\n    interests,\n    created_at,\n    updated_at"};
