...
<svelte:head>
  <title>{$i18n.t('profile.carddav.title')} | Freundebuch</title>
</svelte:head>
...
<div class="bg-white rounded-xl shadow-lg p-8">
  <div class="mb-8">
    ...
    <h1 class="text-3xl font-heading text-forest mt-4">{$i18n.t('profile.carddav.title')}</h1>
    <p class="text-gray-600 font-body mt-1">{$i18n.t('profile.carddav.subtitle')}</p>
  </div>
