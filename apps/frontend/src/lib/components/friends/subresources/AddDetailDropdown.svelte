...
<div class="relative">
  ...
  {#if isOpen}
    ...
    >
      {#if !showSubMenu}
        <!-- Main choice menu: Add Friend or Add Detail -->
        <button
          type="button"
        ...
        >
          ...
          <div>
            <div class="font-semibold">{$i18n.t('friends.newFriend')}</div>
            <div class="text-xs text-gray-500">{$i18n.t('friends.newFriendSubtitle')}</div>
          </div>
        </button>
        <button
          type="button"
        ...
        >
          ...
          <div class="flex-1">
            <div class="font-semibold">{$i18n.t('friendDetail.addDetail')}</div>
            <div class="text-xs text-gray-500">{$i18n.t('friendDetail.addDetailSubtitle')}</div>
          </div>
          <svg class="w-4 h-4 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      {:else}
        <!-- Sub-menu: Detail type options -->
        <button
          type="button"
          onclick={handleBack}
          class="w-full px-4 py-2 text-left text-sm font-body text-gray-500
                 hover:bg-gray-50 flex items-center gap-2 transition-colors border-b border-gray-100"
          role="menuitem"
        >
